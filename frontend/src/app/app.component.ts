...
export class AppComponent implements OnInit {
  public appPages: NavLinks[] = [
    ...
    { title: 'Nearest Services', url: '/properties', icon: 'home' },
    { title: 'Messages', url: '/enquiries', icon: 'reader' },
    { title: 'Life Cost Calc', url: '/cost-calc', icon: 'calculator' },
    { title: 'Assistance', url: '/assistant', icon: 'help' },
